                            ...
                            {data.specs.map((spec, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <span className="font-mono font-normal text-(--gt-light-text) text-sm text-right">
                                            {value}
                                        </span>
                                    </motion.div>
                                )
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            {drinks && drinks.length > 0 && (
                                ...
                                >
                                    <div className="flex items-center gap-3 mb-5">
                                        ...
                                        <h3 className="text-base font-medium text-(--gt-light-text)">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {drinks.map((drink, i) => (
                                            <span
                                                key={i}
                                                className="inline-flex px-3 py-1.5 rounded-lg bg-(--gt-light-surface) text-(--gt-light-text-secondary) text-xs font-light"
                                            >
                                                {drink}
                                            </span>
                                        ))}
                            ...
                            {steps && steps.length > 0 && (
                                <motion.div
                                    ...
                                    className="bg-white rounded-2xl p-7 shadow-sm border border-(--gt-light-border)"
                                >
                                    <h3 className="text-base font-medium text-(--gt-light-text) mb-5">
                                        ...
                                        {steps.map((step, i) => (
                                            <div key={i} className="flex items-center gap-4">
                                                <div className="w-8 h-8 rounded-full bg-(--gt-blue)/8 flex items-center justify-center shrink-0">
                                                    <span className="text-xs font-semibold text-(--gt-blue)">
                                                        {i + 1}
                                                    </span>
                                                </div>
                ...
                {certifications.length > 0 && (
                    ...
                    >
                        {certifications.map((cert, i) => (
                            <span
                                key={i}
                                className="text-xs font-light text-(--gt-light-text-muted) uppercase tracking-wider"
                            >
                                {cert}
                            </span>
                        ))}
